...
ggplot(CTD.li, aes(x=Latitude, y=Depth)) +
  geom_tile(aes(fill=Temperature)) +
  geom_contour(aes(z = Temperature),breaks = 11:17,color="white") +
  scale_y_reverse() +
  labs(y="Depth (m)", fill="Temperature (deg C)") +
...
In oceanography, lot of researchers are using the Ocean Data View ([ODV](https://odv.awi.de)) software to do that kind of job. It is a free software for the interactive exploration, analysis and visualization of oceanographic data. Below is an example with our data:
